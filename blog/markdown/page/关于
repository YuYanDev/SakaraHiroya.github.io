...
Hexo [https://github.com/hexojs/hexo](https://github.com/hexojs/hexo) (Licensed under MIT License)
simplecho [https://github.com/Garwih/hexo-theme-simplecho](https://github.com/Garwih/hexo-theme-simplecho) (Licensed under MIT License)
Vue.js [https://github.com/vuejs/vue](https://github.com/vuejs/vue) (Licensed under MIT License,Copyright (c) 2013-present, Yuxi (Evan) You)
gitment [https://github.com/imsun/gitment](https://github.com/imsun/gitment) (Licensed under MIT License)
Nginx [http://nginx.org/](http://nginx.org/) (Licensed under BSD License)
